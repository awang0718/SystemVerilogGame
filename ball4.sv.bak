...
module  ball ( input         Clk,                // 50 MHz clock
               ...
               output logic  is_ball,            // Whether current pixel belongs to ball or background
					...
					output logic[13:0] Ball_X,
					
					input logic[13:0] enemy_location,
    ...
    parameter [9:0] Ball_X_Start = 10'd325;  // Start position on the X axis
...
//					 						
				...
				if (((player_location + Ball_X_Size <= enemy_location + Ball_X_Size 
						&&	player_location + Ball_X_Size >= enemy_location - Ball_X_Size) 
						||	(player_location - Ball_X_Size <= enemy_location + Ball_X_Size
						&& player_location - Ball_X_Size >= enemy_location - Ball_X_Size)) 
					&&	((player_location + Ball_Y_Size <= enemy_location + Ball_Y_Size 
						&& player_location + Ball_Y_Size >= enemy_location - Ball_Y_Size)
						|| (player_location - Ball_Y_Size <= enemy_location + Ball_Y_Size
						&& player_location - Ball_Y_Size >= enemy_location - Ball_Y_Size))
					&& enemy_hit_en && attack)
    ...
    always_comb begin
	 ...
	 assign is_attack = attack && enemy_hit_en && ~game_over && hit_in;
